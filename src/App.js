...
function App() {
  ...
  // Sample data for pins with real image URLs
  const pins = [
    {
      id: 1,
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCsQV8LrYVblYd8mHkK7w-HH1GUZzLNKlvfA&s",
      user: "InteriorDesign",
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmv5cqPNBg6Ix9JOL9hqlW-H1AKt_Lcw5PuA&s",
      user: "DIYCrafter",
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmfo2pNmr1Uf2nByPAuYPBoEsw6f9zW0lBaA&s",
      user: "UrbanShots",
    ...
    },
    {
      ...
      description: "Optimize your productivity with these workspace arrangements",
      image: "https://mark-cdn.bountixp.com/marketing-v2/wp-content/uploads/2021/10/90913081_m-1.jpg",
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNdgpKj-uBLbR4z06r4JbTR3OEOgumQqvizw&s",
      user: "ArtisticSoul",
  ...
  return (
    <div className="app">
      ...
      <main className="main-content">
        <MasonryGrid pins={filteredPins} onPinClick={handlePinClick} />
        {selectedPin && <PinModal pin={selectedPin} onClose={handleCloseModal} />}
      </main>
    </div>
  )
}
